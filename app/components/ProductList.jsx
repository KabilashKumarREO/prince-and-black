...
const products = [
  ...
  },
  {
    ...
    title: "Gigantic Inflatable Flamingo",
    price: 49,
    description: "",
    image: "/assets/products/",
    category: [""],
  ...
  },
  {
    ...
    title: "Synthetic Clusterfibre Standard Pillow",
    price: 15,
    description: "",
    image: "/assets/products/",
    category: [""],
  ...
  },
  {
    ...
    title: "Notre-Dame de Paris by Victor Hugo",
    price: 12,
    description: "",
    image: "/assets/products/",
    category: [""],
...
const ProductList = () => {
  return (
    <div className="w-[100%] flex flex-row justify-center items-start gap-[36px]">
